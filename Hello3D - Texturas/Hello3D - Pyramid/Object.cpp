...
void Object::loadObj(string filePath)
{
	...
	/*
	string texNames[] = {"../../3D_models/pokeball/pokeball.png",
		...
		"../../3D_models/Pokemon/textures/PikachuDh.png",
		"../../3D_models/joystick/textures/snes-controller_Base_Color.png" };
	



	string texNames[] = { "../../3D_models/map/texture/Base_material_BaseColor.png",
		"../../3D_models/map/texture/Base_material_Height.png",
		"../../3D_models/map/texture/Base_material_Metallic.png",
		"../../3D_models/map/texture/Base_material_Normal.png",
		"../../3D_models/map/texture/Base_material_Roughness.png",
		"../../3D_models/map/texture/Ground_material_BaseColor.png",
		"../../3D_models/map/texture/Ground_material_Height.png",
		"../../3D_models/map/texture/Ground_material_Metallic.png",
		"../../3D_models/map/texture/Ground_material_Normal.png",
		"../../3D_models/pokeball/pokeball.png",
		"../../3D_models/Pokemon/textures/PikachuMouthDh.png",
		"../../3D_models/Pokemon/textures/PikachuDh.png",
		"../../3D_models/Pokemon/textures/PikachuHohoDh.png",
		"../../3D_models/Pokemon/textures/PikachuEyeDh.png",
		"../../3D_models/Pokemon/textures/PikachuDh.png",
		"../../3D_models/sakura/Leaves1Tex.png", 
		"../../3D_models/sakura/Part1Tex.png", 
		"../../3D_models/sakura/Trunk1Tex.png"};
	*/
	...
	if (inputFile.is_open())
	{
		...
		while (!inputFile.eof())
		{
			...
			if (word == "g") //in�cio de um novo grupo
			{
